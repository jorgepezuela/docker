...
# Example:
docker build -t demo6-dockerfile-add-vs-copy:v1 .

# Run Docker Container and Verify
docker run --name my-add-vs-copy-demo -p 8080:80 -d demo6-dockerfile-add-vs-copy:v1
...
docker rmi jorgepezuela/demo6-dockerfile-add-vs-copy:v1
docker rmi demo6-dockerfile-add-vs-copy:v1
