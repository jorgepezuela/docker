...
> **Important Note:** In the commands below, wherever you see `jpezuela`, replace it with your Docker Hub username.
...
> **Note:** Docker Hub sign-in is not required for downloading public images. For example, the Docker image `nginx/latest` is a public image.
...
# Example with 'jpezuela':
docker tag mynginx-custom:v1 jpezuela/mynginx-custom:v1

# Push the Docker image to Docker Hub
docker push YOUR_DOCKER_USERNAME/mynginx-custom:v1

# Example with 'jpezuela':
docker push jpezuela/mynginx-custom:v1
