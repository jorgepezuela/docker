...
docker run --name my-entrypoint-demo3 --entrypoint /bin/sh demo11-dockerfile-entrypoint:v1 -c 'echo "Overridden ENTRYPOINT instruction by Jorge Pezuela!"'

# Expected Output:
# Overridden ENTRYPOINT instruction by Jorge Pezuela!
```
...
- The container outputs `Overridden ENTRYPOINT instruction by Jorge Pezuela!`
