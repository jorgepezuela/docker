...
services:
  ...
  app-ums:
    image: ghcr.io/jorgepezuela/usermgmt-webapp-v6:latest
    ports:
...
# Sample Output
jpezuela-macbook:healthchecks-demo jpezuela$ docker compose ps
...
ums-stack-app-ums-1   ghcr.io/jorgepezuela/usermgmt-webapp-v6:latest   "catalina.sh run"        app-ums     39 seconds ago   Up 38 seconds (healthy)   0.0.0.0:63848->8080/tcp
jpezuela-macbook:healthchecks-demo jpezuela$ 
```
